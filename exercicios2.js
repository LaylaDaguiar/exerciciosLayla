...
console.log(typeof idade)  //ela da o resultado por não estar atribuida a um valor

 nome = "Layla"
 idade = 17           //e necessario atribuir um valor ao comando que desejamos 

console.log(nome)
console.log(idade)

console.log("Ola, ,eu nome eh", nome, "e tenho", idade)
